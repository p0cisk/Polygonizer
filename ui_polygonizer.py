...
#
# Created: Sun Feb 05 21:29:46 2012
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.cbOutput = QtGui.QCheckBox(Form)
        self.cbOutput.setObjectName(_fromUtf8("cbOutput"))
        self.gridLayout.addWidget(self.cbOutput, 4, 0, 1, 2)

        self.retranslateUi(Form)
        QtCore.QObject.connect(self.cbOutput, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.eOutput.setEnabled)
        QtCore.QObject.connect(self.cbOutput, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.btnBrowse.setEnabled)
    ...
    def retranslateUi(self, Form):
        ...
        self.cbOutput.setText(QtGui.QApplication.translate("Form", "Output file", None, QtGui.QApplication.UnicodeUTF8))
